  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 p-4 sm:p-8 font-sans text-gray-800">
      ...
      <div className="max-w-7xl mx-auto">
        <header className={`bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-2xl p-6 sm:p-8 mb-8 border-t-4 border-yellow-400 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
