  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-2xl hover:scale-105 transition-all duration-300"><Clock className="w-12 h-12 mb-4" /><div className="text-6xl font-bold mb-2">1-2s</div><div className="text-green-100 text-lg">Query Response Time</div><div className="mt-4 text-sm text-green-100">Including LLM inference</div></div>
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-2xl hover:scale-105 transition-all duration-300"><Cpu className="w-12 h-12 mb-4" /><div className="text-6xl font-bold mb-2">&lt;5s</div><div className="text-blue-100 text-lg">Document Processing</div><div className="mt-4 text-sm text-blue-100">Full pipeline end-to-end</div></div>
        <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-2xl hover:scale-105 transition-all duration-300"><Activity className="w-12 h-12 mb-4" /><div className="text-6xl font-bold mb-2">100ms</div><div className="text-purple-100 text-lg">Retrieval Speed</div><div className="mt-4 text-sm text-purple-100">Cosine similarity search</div></div>
      </div>
